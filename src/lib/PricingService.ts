...
export class PricingService {
    ...
    private static readonly pricingTable: PricingTable = {
        ...
        'Low_8': {pricePerParticipant: 490, priceInhouse: 1590},
        'Low_16': {pricePerParticipant: 990, priceInhouse: 2990},
        'Low_24': {pricePerParticipant: 1290, priceInhouse: 4290},
        'Low_32': {pricePerParticipant: 1860, priceInhouse: 5390},

        // Medium pricing
        'Medium_2': {pricePerParticipant: 90, priceInhouse: 390},
        'Medium_8': {pricePerParticipant: 550, priceInhouse: 1890},
        'Medium_16': {pricePerParticipant: 1090, priceInhouse: 3580},
        'Medium_24': {pricePerParticipant: 1490, priceInhouse: 5070},
        'Medium_32': {pricePerParticipant: 1990, priceInhouse: 6760},
    ...
    static getPricing(course: Course): PricingEntry | null {
        ...
        const pricingLevel = PricingLevel.Medium; // always use medium for now
        const key = this.getPricingKey(pricingLevel ?? PricingLevel.Medium, durationInHours);
        console.log(key);
        console.log(course);
