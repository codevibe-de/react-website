...
export default function CourseCard({course}: CourseCardProps) {
    ...
    return (
        <Link href={`/seminare/${courseSlug}`} className="block h-full group">
            <div
                className="border border-gray-200 rounded-lg shadow-lg hover:shadow-xl hover:border-gray-400 transition-all duration-300 cursor-pointer bg-white h-full flex flex-col overflow-hidden">
